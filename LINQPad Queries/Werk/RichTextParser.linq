...
void Main()
{
  var rtf = File.ReadAllText(@"C:\Program Files (x86)\Microsoft Visual Studio 14.0\Common7\IDE\Extensions\Microsoft\Microsoft Azure Data Lake Tools for Visual Studio 2015\2.1.0000.0\License\Azure Data Lake Tools for VS.rtf");  
  RichTextStripper.StripRichTextFormat(rtf).Dump();
}
